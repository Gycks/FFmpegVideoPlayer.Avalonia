...
- Rebundle as fork of original package to avoid confusion
- **Audio & Subtitle Track Selection** - Added `AudioTrack` and `SubtitleTrack` properties to `VideoPlayerControl` for selecting audio and subtitle streams. Users can now switch between available tracks during playback.
